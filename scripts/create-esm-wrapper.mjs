...
export const UseRoomFilters = pkg.UseRoomFilters;
...
export const COLYSEUS_FILTERS_METADATA = pkg.COLYSEUS_FILTERS_METADATA;
...
export const getRoomFilterMetadata = pkg.getRoomFilterMetadata;
